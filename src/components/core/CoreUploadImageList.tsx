...
interface CoreUploadImageListProps {
  images: string[];
...
const CoreUploadImageList: FunctionComponent<CoreUploadImageListProps> = ({ images, setImages, className, maxImages = 100 }) => {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files.length > validFiles.length) {
      setErrorMessage('4MB хэмжээнээс хэтрэхгүй байх ёстой.');
      return;
    }
...
export default CoreUploadImageList;
